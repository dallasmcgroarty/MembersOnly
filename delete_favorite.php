...
<body class="container" style="background-color: lightblue;">
  <header>    
    <h1 class="text-center" style="font-family: 'Bangers', cursive; margin-top: 10px">Delete A Favorite Food</h1>
  </header>
  ...
  <div class="d-flex justify-content-center align-self-center form-body" style="background-color: white; width: 60%; border-radius: 5px; margin-top: 20px;">
    <form action="delete_favorite.php" method="post" style="width:80%;">
        <div class="form-group" style="padding-top: 40px; width: 100%">
            <p class=text-center style='color: black; font-weight: bold'>Delete one of your favorite foods</p>
            <?php
                if(empty($_POST['food']))
                {
